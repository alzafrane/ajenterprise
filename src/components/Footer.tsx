    ...
    <footer className="bg-[#0f172a] text-slate-300 py-16 border-t border-slate-800 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-white mb-6 uppercase tracking-wider text-[13px]">Quick Links</h3>
          ...
          {/* Our Services */}
          <div>
            <h3 className="font-bold text-white mb-6 uppercase tracking-wider text-[13px]">Our Services</h3>
            <div className="flex flex-col gap-4">
          ...
          {/* Contact Us */}
          <div>
            <h3 className="font-bold text-white mb-6 uppercase tracking-wider text-[13px]">Contact Us</h3>
            <div className="flex flex-col gap-5">
              <div className="flex items-start gap-3">
                ...
                <span className="text-[15px] text-slate-300 leading-relaxed">
                  G15, Circle, Al-Muqam,
                  <br />Vishala, Sarkhej-Okaf,
                  <br />Ahmedabad, Gujarat 380055
                </span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[15px] text-slate-300">WhatsApp Chat</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-slate-800/60 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} AJ Enterprise. All rights reserved.</p>
          <p>
            Designed for premium local shopping experience.
          </p>
        </div>
      </div>
    </footer>
