    ...
    <section id="why-choose-us" className="py-20 bg-[#FAFAFA]">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-[#C17F59] font-bold tracking-widest uppercase text-[10px] sm:text-xs mb-4">
            Why AJ Enterprise
          </h2>
          ...
          <p className="text-gray-500 text-sm sm:text-base max-w-2xl mx-auto">
            Every laptop goes through rigorous inspection, comes with our
            dedicated support, and is priced to feel like a smart upgrade.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
          ...
          <div className="bg-[#111111] rounded-[24px] p-5 lg:p-6 text-white flex flex-col h-full lg:col-span-1 md:col-span-1 shadow-md">
            <span className="text-gray-500 text-[10px] font-bold tracking-widest uppercase mb-2">
              Trusted By
            </span>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mt-auto">
              Special solutions for offices, students, startups, and bulk orders
              buying refurbished.
            </p>
          </div>
          ...
          <div className="bg-white rounded-[24px] p-5 lg:p-6 border border-gray-200 flex flex-col h-full lg:col-span-1 md:col-span-1 shadow-sm">
            <span className="text-[#C17F59] text-[10px] font-bold tracking-widest uppercase mb-2">
              Our Promise
            </span>
            <h4 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-1 tracking-tight leading-tight">
              Why
              <br />
              AJ Enterprise?
            </h4>
            <p className="text-gray-500 text-sm leading-relaxed mb-4">
              Every laptop is tested, fully functional, and priced to deliver
              maximum value.
            </p>
          ...
          <div className="bg-[#F4FBFA] rounded-[24px] p-5 lg:p-6 border border-[#E5F4F2] flex flex-col sm:flex-row gap-4 sm:gap-6 lg:col-span-2 md:col-span-2 items-start sm:items-center shadow-sm">
            <div className="flex-1 order-2 sm:order-1">
              <span className="block text-[#00A67E] text-[10px] font-bold tracking-widest uppercase mb-2">
                Quality Certified
              </span>
              <h4 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-1 tracking-tight">
                31-Category
              </h4>
              <h5 className="text-gray-900 font-semibold mb-1 text-sm">
                Inspection on every device
              </h5>
              <p className="text-gray-500 text-sm leading-relaxed max-w-md">
                Battery, keyboard, ports, display, thermals, and overall
                performance are checked before delivery.
              </p>
            </div>
          ...
          <div className="bg-white rounded-[24px] p-5 lg:p-6 border border-gray-200 flex flex-col h-full lg:col-span-1 md:col-span-1 shadow-sm">
            <span className="text-[#D4AF37] text-[10px] font-bold tracking-widest uppercase mb-2">
              Rated On Google
            </span>
            <h4 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-1 tracking-tight">
              4.8
            </h4>
            <p className="text-gray-500 text-[13px] leading-relaxed mt-auto mb-2">
              From satisfied customer reviews
            </p>
          ...
          <div className="bg-[#111111] rounded-[24px] p-5 lg:p-6 text-white flex flex-col h-full lg:col-span-1 md:col-span-1 relative overflow-hidden shadow-md">
            ...
            <h5 className="text-sm font-semibold mb-1 relative z-10 text-gray-200">
              Savings vs retail
            </h5>
            <p className="text-gray-400 text-sm leading-relaxed mt-auto relative z-10">
              Flagship performance and business-grade machines at a much smarter
              price point.
            </p>
          </div>
          ...
          <div className="bg-[#F5F8FF] rounded-[24px] p-5 lg:p-6 border border-[#E5EDFF] flex flex-col sm:flex-row gap-4 sm:gap-6 lg:col-span-2 md:col-span-2 items-start sm:items-center shadow-sm">
            ...
            <div className="flex-1">
              <span className="block text-blue-500 text-[10px] font-bold tracking-widest uppercase mb-1">
                Full Coverage
              </span>
              <h4 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-1 tracking-tight">
                Fast Support
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Hardware defect or query? We handle repairs or replacements with
                quick support via Call and WhatsApp.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#111111] rounded-[24px] p-5 lg:p-6 text-white flex flex-col h-full lg:col-span-1 md:col-span-1 shadow-md">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mt-auto">
              Always ready to deliver exactly what you need quickly across
              Ahmedabad.
            </p>
          </div>
          ...
          <div className="bg-white rounded-[24px] p-5 lg:p-6 border border-gray-200 flex flex-col h-full lg:col-span-1 md:col-span-1 shadow-sm">
            <span className="text-[#00A67E] text-[10px] font-bold tracking-widest uppercase mb-2">
              Performance
            </span>
            <h4 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-1 tracking-tight">
              Upgrades
            </h4>
            <h5 className="text-sm font-semibold mb-1 text-gray-700">
              RAM & SSD Options
            </h5>
            <p className="text-gray-500 text-sm leading-relaxed mt-auto">
              Custom configurations available as per customer requirements for
          ...
          <div className="bg-gradient-to-r from-white to-gray-50 rounded-[24px] p-5 lg:p-6 border border-gray-200 flex flex-col sm:flex-row gap-4 sm:gap-6 lg:col-span-2 md:col-span-2 items-start sm:items-center shadow-sm">
            <div className="flex-1">
              <span className="block text-[#C17F59] text-[10px] font-bold tracking-widest uppercase mb-1">
                Huge Selection
              </span>
              <h4 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-1 tracking-tight">
                Top Brands
              </h4>
              <h5 className="text-gray-700 font-semibold mb-1 text-sm">
                Multiple configurations
              </h5>
              <p className="text-gray-500 text-sm leading-relaxed max-w-md">
                Dell, HP, Lenovo, and Apple MacBook available across student,
                business, and creator needs. Second Hand Laptop Ahmedabad.
              </p>
            </div>
          </div>
        </div>
