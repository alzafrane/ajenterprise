        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8 xl:gap-12">
          <div className="lg:w-1/2 space-y-6 z-10 lg:pr-8 xl:pr-12">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 mt-6">
              <a
                href="#laptops"
                className="inline-flex justify-center items-center gap-2 bg-[#0f172a] hover:bg-gray-800 text-white px-8 py-3.5 rounded-xl font-bold transition-all shadow-lg hover:-translate-y-0.5 w-full sm:w-auto"
              >
                Get Best Deal <ArrowRight size={18} />
              </a>
              <a
                href="#laptops"
                className="inline-flex justify-center items-center gap-2 bg-white text-gray-900 border border-gray-200 hover:border-gray-300 px-8 py-3.5 rounded-xl font-bold transition-all shadow-sm w-full sm:w-auto"
              >
          ...
          <div className="lg:w-1/2 relative w-full mt-10 lg:mt-0">
            ...
            <div
              className="absolute top-4 left-4 sm:-top-6 sm:-left-10 bg-white p-3 sm:p-4 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border border-gray-50 flex items-center gap-3 sm:gap-4 animate-bounce z-30"
